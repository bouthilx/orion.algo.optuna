# -*- coding: utf-8 -*-
#
# orion.algo.optuna documentation build configuration file.
#
...
import orion.algo.optuna as algo_plugin
...
latex_documents = [
  (master_doc, 'orion.algo.optuna.tex',
   u'Oríon algo optuna Documentation',
...
texinfo_documents = [
  (master_doc, 'optuna',
   u'Oríon algo optuna Documentation',
   author, 'optuna', algo_plugin.__descr__,
   'Miscellaneous'),
]
